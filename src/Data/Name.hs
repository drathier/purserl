...
-- [drathier]: semigroup for messing around
instance Semigroup Name where
  a <> b = Utf8.fromChars (Utf8.toChars a <> Utf8.toChars b)

stripPrefix :: Name -> Name -> Name
stripPrefix prefix name =
  case List.stripPrefix (Utf8.toChars prefix) (Utf8.toChars name) of
    Nothing -> name
    Just withoutPrefix -> Utf8.fromChars withoutPrefix

...
contains (W8# word#) (Utf8 ba#) =
  containsHelp (word8ToWord# word#) ba# 0# (sizeofByteArray# ba#)


containsHelp :: Word# -> ByteArray# -> Int# -> Int# -> Bool
containsHelp word# ba# !offset# len# =
  if isTrue# (offset# <# len#) then
    if isTrue# (eqWord# word# (word8ToWord# (indexWord8Array# ba# offset#)))
      then True
...
split (W8# divider#) str@(Utf8 ba#) =
  splitHelp str 0 (findDividers (word8ToWord# divider#) ba# 0# (sizeofByteArray# ba#) [])
...
findDividers divider# ba# !offset# len# revOffsets =
  if isTrue# (offset# <# len#) then
    findDividers divider# ba# (offset# +# 1#) len# $
      if isTrue# (eqWord# divider# (word8ToWord# (indexWord8Array# ba# offset#)))

...
module Reporting.Annotation
  ...
  , one
  -- [drathier]
  , placeholderThrowingAwayDocs
  , placeholderThrowingAwayStuff
  )
  where
...
-- [drathier]
placeholderThrowingAwayDocs :: Region
placeholderThrowingAwayDocs =
  Region (Position 123 123) (Position 123 1234)

placeholderThrowingAwayStuff :: Region
placeholderThrowingAwayStuff =
  Region (Position 223 223) (Position 223 2234)
